...
export function ProductItems({
  ...
  tag: "new" | "popular" | "onSale" | undefined;
}) {
            ...
            <div className="p-1">
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p
                    className={`text-3xl text-primary font-bold ${tag === "onSale" && "line-through opacity-50"}`}
                  >
                    $ {product.price}
                  </p>
                </div>
              ...
              <Button
                variant="secondary"
                className="text-lg w-full mt-2 cursor-pointer"
              >
                Add to Cart
              </Button>
            </div>
